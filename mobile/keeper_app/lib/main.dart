...
const appTitle = 'Honey Chain Keeper';

// This computer's Wi-Fi address at build time — used until the keeper changes it in-app (long-press the
...
const defaultServerUrl = 'http://172.16.127.61:5173';
...
class _WebShellState extends State<WebShell> {
  ...
  WebViewController _buildController(String url) {
    ...
    controller
      ...
      ..setBackgroundColor(const Color(0xFFF4FBFB))
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: const InputDecoration(
            hintText: 'http://192.168.1.8:5173',
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                ...
                child: Container(height: 14, color: const Color(0xFFF4FBFB)),
              ),
              Expanded(
                child: Stack(
                  children: [
